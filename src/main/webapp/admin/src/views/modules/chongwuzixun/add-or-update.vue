<template>
  <div>
    ...
    >
      <el-row>
                  <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="资讯名称" prop="zixunmingcheng">
          <el-input v-model="ruleForm.zixunmingcheng" 
              placeholder="资讯名称" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.zixunmingcheng" label="资讯名称" prop="zixunmingcheng">
              <el-input v-model="ruleForm.zixunmingcheng" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chongwuzixun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chongwuzixunCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
